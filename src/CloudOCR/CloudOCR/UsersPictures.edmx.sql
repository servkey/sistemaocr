...
-- --------------------------------------------------
-- Date Created: 02/19/2014 00:30:46
-- Generated from EDMX file: D:\Documents\Visual Studio 2013\Projects\CloudOCR\CloudOCR\UsersPictures.edmx
-- --------------------------------------------------
...
-- Creating foreign key on [AspNetUsersId] in table 'PicturesSet'
ALTER TABLE [dbo].[PicturesSet]
ADD CONSTRAINT [FK_AspNetUsersPictures]
    FOREIGN KEY ([AspNetUsersId])
    REFERENCES [dbo].[AspNetUsers]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_AspNetUsersPictures'
CREATE INDEX [IX_FK_AspNetUsersPictures]
ON [dbo].[PicturesSet]
    ([AspNetUsersId]);
GO
